...
async function fixVendorCompany() {
    try {
        ...
        if (existingVendorCompany) {
            const existingCompanyId = existingVendorCompany.companyId;
        ...
        console.log(`  ${colors.bright}Company Name:${colors.reset} ${colors.cyan}${vendorCompany?.Company?.companyName || 'N/A'}${colors.reset}`);
        console.log('\n' + '='.repeat(80));
...
// Run the script
fixVendorCompany();
//# sourceMappingURL=fix-vendor-company.js.map