...
import { sendVendorAttachedEmail, sendStatusChangeEmail, sendDealCreatedEmail, sendPmDealStatusNotificationEmail, sendDealSummaryPDFEmail, sendApprovalPendingEmail, sendApprovalApprovedEmail, sendApprovalRejectedEmail, } from '../services/email.service.js';
import { sendComparisonEmail, sendVendorWonEmail, sendVendorLostEmail, } from '../modules/bidComparison/bidComparison.email.js';
...
function printTestStart(testName, testNumber) {
...
async function runTest(testName, testNumber, testFn) {
